    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <select id="role" name="role" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                ...
                <option value="principal" @selected(old('role') === 'principal')>Principal</option>
            </select>
        ...
        <div class="mt-4">
            <x-input-label for="captcha_answer" :value="'Captcha: Solve '.$captchaQuestion" />
            <x-text-input
                id="captcha_answer"
            ...
            <p class="mt-1 text-xs text-slate-500">This is a custom captcha check to block automated signups.</p>
        </div>
